...
const contactsData = [
  ...
  },
  {
    ...
    name: "linkedin.com/in/aufaikrimah/",
  },
  {
...
const socmedData = [
  ...
  },
  {
    ...
    link: "https://wa.me/6289506591035",
  },
  {
    ionic: "logo-linkedin",
    link: "https://www.linkedin.com/in/aufaikrimah/",
  },
  {
    ...
    link: "https://www.instagram.com/aufaikrimaa/",
  },
];

const socmedContainer = document.querySelector(".socmed-list");

socmedData.forEach((data) => {
  const socmedHTML = `<a
      href="${data.link}"
      target="_blank"
      ><div
  ...
  socmedContainer.innerHTML += socmedHTML;
});
...
const projectsData = [
  {
    id: 1,
    title: "awaMovies",
    photo: "./assets/images/awamovies.png",
    lang: "TypeScript, Vue, Nuxt, Tailwind",
    desc: "A Nuxt.js Movies application",
    link: "https://awamovies.vercel.app/",
    github: "https://github.com/aufaikrimaa/movies-app",
  ...
  },
  {
    ...
    lang: "ReactJs, Tailwind, GSAP",
    desc: "Web Profile of LensaKita.",
    link: "https://lensakitaa.vercel.app/",
